      ...
      {sidebarStore.open && (
        ...
        >
          <div className="flex flex-row">
            {web3Store.active && (
              <div className=" block  text-sm text-right flex-grow whitespace-nowrap">
                <div className="p-1 m-1 inline-block bg-neutral-600 text-green-500 rounded rainbow-underline cursor-pointer ">
