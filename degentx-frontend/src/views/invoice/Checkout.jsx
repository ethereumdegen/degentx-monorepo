...
function Main() {
  ...
  observe(web3Store, "chainId", function () {
    setNetworkChainId(web3Store.chainId);
  });
    ...
    const fetchData = async () => {
      try {
        if (invoiceUuidToCheck != null) {
          ...
          let invoice_status_endpoint_url =
            "https://api.degentx.com/api/paid_invoices";
  ...
  const incorrectChainId =
    generatedInvoice?.chainId?.toString() != networkChainId?.toString();
  ...
  return (
    <>
      {pendingTransaction && (
        ...
        >
          <div className="text-center font-bold">Transaction Pending</div>
          <div className="text-center  ">
            <Lucide
              icon="Loader"
              className="w-6 h-6 mx-auto my-2 animate-spin "
            />
          </div>
                        ...
                        <FlexContainer>
                          ...
                          {paymentTokenData && (
                            <FlexItem>
                              ...
                              <Value>
                                {currency_amount_raw_to_formatted(
                                  amountDueGrandTotal,
                                  paymentTokenData?.decimals
                                )}{" "}
                                {paymentTokenData?.label}{" "}
                              </Value>
                            </FlexItem>
                          )}
                          ...
                          <div>
                            ...
                            {incorrectChainId && web3Store.account && (
                              <div className="my-4 p-2 text-center  ">
                                Connect to the{" "}
                                {getNetworkNameFromChainId(
                                  generatedInvoice?.chainId
                                ).toString()}{" "}
                                    ...
                                    if (tx.success) {
                                      ...
                                      if (tx?.data?.hash) {
                                        setPendingTransaction({
                                          hash: tx?.data?.hash,
                                          chainId: generatedInvoice.chainId,
                                        });
                                      }
